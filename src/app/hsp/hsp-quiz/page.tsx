...
export default function SensitiveQuiz(){
  return (
        ...
        <div className="bg-gray-50 rounded-xl shadow-sm border border-gray-200 p-2 mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 px-3  ">
            <div className="flex-1">
              ...
              This 12-question assessment will help you Discover if you have heightened sensory and emotional sensitivity and provide tailored recommendations for articles (Blog posts), streaks, courses, and resources that match your unique needs.
                </p>
              <div className="flex items-center gap-2 mt-3 text-xs text-gray-600">
                <Users className=" text-gray-500 w-4 h-4" />
                <span>9 people have taken this quiz</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-500 leading-relaxed text-sm">
                This assessment evaluates whether you exhibit traits of a Highly Sensitive Person (HSP), characterized by deep emotional responses, high empathy, and sensitivity to environmental stimuli. Based on psychological research, it provides insights into your sensory processing style and offers strategies to thrive as an HSP or adapt to sensitivity. This quiz is designed to assess whether you exhibit traits of a Highly Sensitive Person (HSP), based on Dr. Elaine Aron's pioneering research on sensory-processing sensitivity (SPS), a trait found in approximately 15-20% of the population. The quiz draws from Aron's validated HSP Self-Test (available on hsperson.com) and incorporates insights from peer-reviewed studies, such as those published in Personality and Individual Differences (e.g., Aron & Aron, 1997), which identify key HSP characteristics: deep emotional processing, high empathy, sensitivity to stimuli (e.g., noise, light), and a tendency to feel overwhelmed in chaotic environments.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-sm text-gray-900">1.3 min</span>
                </div>
              </div>
            </div>
