          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 px-3  ">
            <div className="flex-1">
              <p className="text-gray-500 text-xs  leading-relaxed">
               This 12-question assessment will help you Discover where you fall on the personality spectrum and provide tailored recommendations for articles (Blog posts), streaks, courses, and resources that match your unique needs.
                </p>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-gray-500 leading-relaxed text-sm">
                This assessment explores your social energy, preferences for interaction, and how you recharge, based on psychological research into extraversion and introversion. It helps identify if you're primarily introverted (recharging in solitude), extroverted (thriving in social settings), or ambiverted (adapting flexibly), providing insights for better self-understanding and interpersonal dynamics. Based on scientific research into personality traits, particularly the extraversion-introversion spectrum from Carl Jung's theory and validated in modern assessments like the Big Five Personality Traits (OCEAN model), this quiz draws from established sources such as Susan Cain's "Quiet" quiz (adapted from characteristics accepted by researchers), the Eysenck Personality Inventory, and traits outlined in Verywell Mind and Psychology Today tests. These focus on energy sources (social vs. solitary), social preferences, and behavioral patterns.
              </p>
            </div>
